...
/* --- F-Var: --- */
MOV(R1, IMM(521)); // Value of Free var bucket.Address
MOV(R2,INDD(R1,0));
MOV(R0,R2);
...
/* The Compiled Function: */
/* --- F-Var: --- */
MOV(R1, IMM(406)); // Value of Free var bucket.Address
MOV(R2,INDD(R1,0));
MOV(R0,R2);
CMP(INDD(R0,0), IMM(T_CLOSURE));
JUMP_NE(ERROR);
...
/* The Compiled Function: */
/* --- F-Var: --- */
MOV(R1, IMM(466)); // Value of Free var bucket.Address
MOV(R2,INDD(R1,0));
MOV(R0,R2);
CMP(INDD(R0,0), IMM(T_CLOSURE));
JUMP_NE(ERROR);
