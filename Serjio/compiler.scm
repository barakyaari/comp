...
(define cgen
	(lambda (pe env-len params-len) 
		...
		(cond 
			...
			((box-set-pe? pe) (disp pe "set-pe") (cgen-box-set (cdr pe) env-len params-len))
			((box-get-pe? pe) (disp pe "get-pe") (cgen-box-get (cadr pe) env-len params-len))
...
(define (get-primitive-label name)
	(cond 
		...
		((equal? name "string?") "IS_STRING") ; string?
